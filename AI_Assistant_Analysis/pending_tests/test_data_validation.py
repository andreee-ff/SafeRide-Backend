...
@pytest.mark.asyncio
async def test_invalid_datetime_format(test_client: AsyncClient, auth_headers: dict[str, str]):
...
@pytest.mark.asyncio
async def test_special_characters_in_title(test_client: AsyncClient, auth_headers: dict[str, str]):
...
@pytest.mark.asyncio
async def test_very_long_title(test_client: AsyncClient, auth_headers: dict[str, str]):
